...
class drugeschoseAdapter extends TypeAdapter<drugeschose> {
  @override
  final int typeId = 7;

  @override
  drugeschose read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
  ...
  @override
  void write(BinaryWriter writer, drugeschose obj) {
    writer
      ..writeByte(4)
      ..writeByte(0)
      ..write(obj.idpatient)
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is drugeschoseAdapter &&
          runtimeType == other.runtimeType &&
          typeId == other.typeId;
}

class diseasechoseAdapter extends TypeAdapter<diseasechose> {
  @override
  final int typeId = 8;

  @override
  diseasechose read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
  ...
  @override
  void write(BinaryWriter writer, diseasechose obj) {
    writer
      ..writeByte(1)
      ..writeByte(0)
      ..write(obj.disease);
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is diseasechoseAdapter &&
          runtimeType == other.runtimeType &&
          typeId == other.typeId;
}

class patientdiseaseAdapter extends TypeAdapter<patientdisease> {
  @override
  final int typeId = 9;

  @override
  patientdisease read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return patientdisease(
      idpatient: fields[0] as String,
      namedisease: fields[1] as String,
      date: fields[2] as String,
    );
  }

  @override
  void write(BinaryWriter writer, patientdisease obj) {
    writer
      ..writeByte(3)
      ..writeByte(0)
      ..write(obj.idpatient)
      ..writeByte(1)
      ..write(obj.namedisease)
      ..writeByte(2)
      ..write(obj.date);
  }
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is patientdiseaseAdapter &&
          runtimeType == other.runtimeType &&
          typeId == other.typeId;
}
